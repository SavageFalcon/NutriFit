...
import 'add_reciept_model.dart';
export 'add_reciept_model.dart';

class AddRecieptWidget extends StatefulWidget {
  const AddRecieptWidget({
    super.key,
    this.userProfile,
    int? calorieCounter,
  ...
  @override
  State<AddRecieptWidget> createState() => _AddRecieptWidgetState();
}

class _AddRecieptWidgetState extends State<AddRecieptWidget>
    with TickerProviderStateMixin {
  late AddRecieptModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddRecieptModel());
