...
import 'addfridge_model.dart';
export 'addfridge_model.dart';

class AddfridgeWidget extends StatefulWidget {
  const AddfridgeWidget({
    super.key,
    this.userProfile,
    int? calorieCounter,
  ...
  @override
  State<AddfridgeWidget> createState() => _AddfridgeWidgetState();
}

class _AddfridgeWidgetState extends State<AddfridgeWidget>
    with TickerProviderStateMixin {
  late AddfridgeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddfridgeModel());
                            ...
                            Padding(
                              ...
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  labelText:
                                      'You can type any other info here, such as\nthings that mght be obscured, or new ingredients.',
                                  labelStyle:
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  FFButtonWidget(
                                    onPressed: () async {
                                      await FridgeActualRecord.collection
                                          .doc()
                                          .set({
                                        ...createFridgeActualRecordData(
                                          desc: _model
