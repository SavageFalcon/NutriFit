...
class _TrendsWidgetState extends State<TrendsWidget>
  ...
  void initState() {
    ...
    _model.ailmentsController1 ??= TextEditingController();
    _model.ailmentsFocusNode1 ??= FocusNode();

    _model.ailmentsController2 ??= TextEditingController();
    _model.ailmentsFocusNode2 ??= FocusNode();
                          ...
                          Expanded(
                            child: Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  20.0, 20.0, 20.0, 0.0),
                              child: TextFormField(
                                controller: _model.ailmentsController1,
                                focusNode: _model.ailmentsFocusNode1,
                                obscureText: false,
                                decoration: InputDecoration(
                                  labelText: 'Calories Gained',
                                  labelStyle:
                                      FlutterFlowTheme.of(context).bodySmall,
                                  hintText: 'Simple Entry',
                                  hintStyle:
                                      FlutterFlowTheme.of(context).bodySmall,
                                  enabledBorder: OutlineInputBorder(
                                    borderSide: BorderSide(
                          ...
                          Expanded(
                            child: Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  20.0, 20.0, 20.0, 0.0),
                              child: TextFormField(
                                controller: _model.ailmentsController2,
                                focusNode: _model.ailmentsFocusNode2,
                                obscureText: false,
                                decoration: InputDecoration(
